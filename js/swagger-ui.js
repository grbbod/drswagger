...
function program1(depth0,data) {
  ...
  buffer += escapeExpression(stack1)
    + "?apiKey="+jQuery('#input_apiKey').val()+"'>Raw</a>\n    </li>\n  </ul>\n</div>\n<ul class='endpoints' id='";
  if (stack1 = helpers.id) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.id; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.showStatus = function(response) {
      ...
      if (!content) {
        ...
        code = jQuery('<code />').text(JSON.stringify(JSON.parse(content), null, "  "));
        pre = jQuery('<pre class="json" />').append(code);
      ...
      response_body = pre;
      jQuery(".request_url", jQuery(this.el)).html("<pre>" + url + "</pre>");
      jQuery(".response_code", jQuery(this.el)).html("<pre>" + response.status + "</pre>");
      jQuery(".response_body", jQuery(this.el)).html(response_body);
      jQuery(".response_headers", jQuery(this.el)).html("<pre>" + JSON.stringify(response.headers, null, "  ").replace(/\n/g, "<br>") + "</pre>");
